...
#Read check values
file1 = open("C:/xampp/htdocs/radius_college/GitHub/rollercoaster-check/rules/age.txt", "r")
age_check = int(file1.read())
file1.close()

file2 = open("C:/xampp/htdocs/radius_college/GitHub/rollercoaster-check/rules/height.txt", "r")
